    ...
    with get_db() as conn:
        query = """
            SELECT
                ...
                COALESCE(r.oil1_tank1_net, 0) + COALESCE(r.oil1_tank2_net, 0) + COALESCE(r.oil1_tank3_net, 0) AS actual_net,
                COALESCE(r.oil1_tank1_gross, 0) + COALESCE(r.oil1_tank2_gross, 0) + COALESCE(r.oil1_tank3_gross, 0) AS actual_gross,
